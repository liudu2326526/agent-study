set -gx CONDA_EXE "/opt/miniconda3/conda-bld/conda_1765567809749/_h_env_placehold_placehold_placehold_placehold_placehold_placehold_placehold_placehold_placehold_placehold_placehold_placehold_placehold_placehold_placehold_placehold_placehold_placehold_placehold_placehold_pl/bin/conda";
set -gx _CONDA_EXE "/opt/miniconda3/conda-bld/conda_1765567809749/_h_env_placehold_placehold_placehold_placehold_placehold_placehold_placehold_placehold_placehold_placehold_placehold_placehold_placehold_placehold_placehold_placehold_placehold_placehold_placehold_placehold_pl/bin/conda";
set -e _CE_M || true;
set -e _CE_CONDA || true;
set -gx CONDA_PYTHON_EXE "/opt/miniconda3/conda-bld/conda_1765567809749/_h_env_placehold_placehold_placehold_placehold_placehold_placehold_placehold_placehold_placehold_placehold_placehold_placehold_placehold_placehold_placehold_placehold_placehold_placehold_placehold_placehold_pl/bin/python";
set -gx _CONDA_ROOT "/opt/miniconda3/conda-bld/conda_1765567809749/_h_env_placehold_placehold_placehold_placehold_placehold_placehold_placehold_placehold_placehold_placehold_placehold_placehold_placehold_placehold_placehold_placehold_placehold_placehold_placehold_placehold_pl";
